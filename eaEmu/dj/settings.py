...
import os
DATABASE_NAME = os.path.abspath('eaEmu.db')             # Or path to database file if using sqlite3.
DATABASE_USER = 'eaEmu'             # Not used with sqlite3.
DATABASE_PASSWORD = 'HZeLpG2rB825LnFc'         # Not used with sqlite3.
#setup account and listening interfaces before using this: DATABASE_HOST = '192.168.0.113'             # Set to empty string for localhost. Not used with sqlite3.
